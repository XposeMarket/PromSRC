...
## 24C) Gateway-Owned Runtime Workers
...
- Model children default to a 1,024 MiB V8 old-space ceiling (`PROMETHEUS_MODEL_WORKER_MAX_OLD_SPACE_MB`, clamped 256–4,096 MiB) and recycle after ten calls; an inherited explicit Node heap flag wins.
...
- Model workers default to a three-process, 100-job queue, recycle after ten jobs, fail after 45 seconds without heartbeat, and get five seconds to honor cancellation. They have no fixed long-turn timeout.
