...
**Step 3:** Read `.smallclaw/integrations-state.json` — if any integrations show `"status": "broken"` or if the file is empty with no integrations configured, note it briefly in your reply.
