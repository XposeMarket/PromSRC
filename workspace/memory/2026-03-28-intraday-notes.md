...
**Objective:** Refresh windows-shell-playbook skill to remove legacy [redacted to not corrupt - just ignore] references, align examples to Prometheus workspace paths, and add explicit non-Windows fallback guidance.
...
**Verification:**
- ✅ Zero [redacted to not corrupt - just ignore] references in file or subdirectory
