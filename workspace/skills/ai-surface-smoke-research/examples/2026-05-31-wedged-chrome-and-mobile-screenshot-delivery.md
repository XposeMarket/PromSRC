# 2026-05-31 Example: Wedged Chrome CDP + Mobile Screenshot Delivery

Observed during repeated AI smoke-test runs on 2026-05-31.

## Trigger

Raul asked variants of:
...
- Desktop window discovery found Codex and Claude.
- Focusing Codex and Claude worked when using the desktop window tools.
...
1. Load this skill plus desktop/browser/X playbooks.
2. Focus Codex and Claude first; use exact handles when possible.
3. Capture fresh screenshots after focus and explicitly deliver them to the mobile origin.
...
```markdown
Done — smoke test ran.
- Desktop focus: Codex <worked/blocked>, Claude <worked/blocked>.
