...
Always write to: `<prometheus-workspace>\workspace\memory\error_log.jsonl`
Summary file: `<prometheus-workspace>\workspace\memory\error_summary.json`
...
LOG_PATH = Path(r"<prometheus-workspace>\workspace\memory\error_log.jsonl")
...
SUMMARY_PATH = Path(r"<prometheus-workspace>\workspace\memory\error_summary.json")
