...
4. Synthesize into categories Raul actually cares about:
...
6. Only save a file or note if Raul asked, the signal is important, or the run should feed Daily X Signal Radar.
...
- Do not over-index on crypto/gambling/engagement bait unless Raul asks.
