...
Use this note when Raul asks to “test,” “try,” or validate a newly connected external service/tool.

## Evidence

On 2026-05-11 Raul asked Prometheus to test newly connected Stripe tools. The successful path was connector-first:
...
- If a connector exists and is connected, test only safe actions by default unless Raul explicitly approves writes.
