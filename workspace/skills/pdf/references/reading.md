# Migrated pdf-reader guidance

This reference preserves detailed guidance from the former `pdf-reader` entrypoint. Read it only for the matching operation.
...
| Error | Fix |
|---|---|
| `Cannot find module 'pdf-parse'` | Run `node workspace\doc-skills-setup.js` from `<prometheus-workspace>` |
