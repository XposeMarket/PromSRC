# Migrated json-and-config-surgery guidance

This reference preserves detailed guidance from the former `json-and-config-surgery` entrypoint. Read it only for the matching operation.
