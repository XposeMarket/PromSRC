...
2. Do not ask Raul to paste raw Client Secrets into chat.
3. Prefer a browser/terminal flow where Raul enters the Client Secret directly into the local prompt, or use an approved vault/secret reference if available.
