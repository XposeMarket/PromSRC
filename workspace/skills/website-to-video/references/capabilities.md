...
- **MotionPathPlugin** — curve-constrained tweens (`skills/hyperframes-animation/techniques.md`)
...
Documented in `hyperframes-animation/transitions/` across the category references. All are GSAP-driven; do not mix them with shader transitions in the same composition.
...
### [Marker/emphasis patterns](../../hyperframes-animation/rules/css-marker-patterns.md)
...
- Exits by energy ([caption motion](../../media-use/audio/references/captions/motion.md)): scatter, drop, collapse, fade+slide, fade
- Tone mappings ([caption authoring](../../media-use/audio/references/captions/authoring.md)): scale-pop `back.out(1.7)`, fade+slide `power3.out`, typewriter, bounce, `elastic.out`, word-by-word
...
Documented in `skills/hyperframes-animation/adapters/html-in-canvas-patterns.md`.
...
(From `skills/hyperframes-animation/techniques.md`)
...
## 23. Current reference inventory

- [Text effects](../../hyperframes-animation/adapters/animate-text.md) — named seek-safe text animation vocabulary and implementation.
- [Transition overview](../../hyperframes-animation/transitions/overview.md), [catalog](../../hyperframes-animation/transitions/catalog.md), and category references.
- [Marker patterns](../../hyperframes-animation/rules/css-marker-patterns.md) and [animation techniques](../../hyperframes-animation/techniques.md).
- [Caption motion](../../media-use/audio/references/captions/motion.md), [caption authoring](../../media-use/audio/references/captions/authoring.md), and [transcription](../../media-use/audio/references/transcribe.md).
- Creative direction: [motion principles](../../hyperframes-creative/references/motion-principles.md), [typography](../../hyperframes-creative/references/typography.md), [narration](../../hyperframes-creative/references/narration.md), [audio-reactive visuals](../../hyperframes-creative/references/audio-reactive.md), [beat direction](../../hyperframes-creative/references/beat-direction.md), [design picker](../../hyperframes-creative/references/design-picker.md), [prompt expansion](../../hyperframes-creative/references/prompt-expansion.md), [video composition](../../hyperframes-creative/references/video-composition.md), and [visual styles](../../hyperframes-creative/references/visual-styles.md).
