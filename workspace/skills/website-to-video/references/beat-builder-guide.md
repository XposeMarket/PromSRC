...
| ------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------- |
| [techniques.md](../../hyperframes-animation/techniques.md)                           | Primitive animation techniques: SVG path drawing, Canvas 2D, CSS 3D, kinetic type, variable fonts, MotionPath, etc.           | Beat uses any of these techniques                 |
| [animate-text.md](../../hyperframes-animation/adapters/animate-text.md)               | Named, seek-safe text-animation effects and their implementation contract                                                     | Beat has text animation                           |
| [html-in-canvas-patterns.md](../../hyperframes-animation/adapters/html-in-canvas-patterns.md) | HTML-in-Canvas: device mockups, magnetic, portal, shatter, text cursor                                                   | Beat uses device mockups or WebGL effects on HTML |
| [transition overview](../../hyperframes-animation/transitions/overview.md)            | Transition selection and the HyperFrames transition contract                                                                  | Beat has shader transitions                       |
| [transition catalog](../../hyperframes-animation/transitions/catalog.md)              | CSS transition families: push, scale, dissolve, blur, 3D, light, distortion, grid, mechanical, and destruction               | Beat uses CSS transitions                         |
| [CSS marker patterns](../../hyperframes-animation/rules/css-marker-patterns.md)        | Text markers: highlight sweeps, hand-drawn circles, burst lines, scribble, and sketchout                                      | Beat uses text emphasis/markers                   |
| [audio-reactive.md](../../hyperframes-creative/references/audio-reactive.md)           | Bass→scale, mid→shape, treble→glow mappings                                                                                   | Beat reacts to music/audio                        |
| [caption authoring](../../media-use/audio/references/captions/authoring.md)            | Timed caption authoring, styling, and positioning                                                                              | Beat includes captions                            |
| [typography.md](../../hyperframes-creative/references/typography.md)                   | Font hierarchy, variable fonts, responsive type scaling                                                                       | Beat has complex typography                       |
| [motion-principles.md](../../hyperframes-creative/references/motion-principles.md)     | Velocity matching, easing philosophy, motion continuity                                                                       | Beat needs polished motion design                 |
| [counting-dynamic-scale.md](../../hyperframes-animation/rules/counting-dynamic-scale.md) | Counter animation and dynamic scale behavior                                                                                | Beat has counters or data visualization           |
| [video-composition.md](../../hyperframes-creative/references/video-composition.md)     | Frame composition, color presence, scale, density rules                                                                       | General composition quality                       |
