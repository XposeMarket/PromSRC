...
- `browser_delivery_tool(caption)` — send the current browser viewport screenshot to the configured messaging channel
...
If the user needs to see what the browser currently shows, use `browser_delivery_tool(caption)` after orienting the page correctly.
