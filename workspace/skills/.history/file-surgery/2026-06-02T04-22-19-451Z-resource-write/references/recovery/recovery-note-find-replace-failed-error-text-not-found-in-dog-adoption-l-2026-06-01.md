# Recovery note: find_replace failed: ERROR: Text not found in dog-adoption-landing-page/index.html. Likely
...
## Future Trigger
Use this when file-surgery hits this failure pattern: find_replace failed: ERROR: Text not found in dog-adoption-landing-page/index.html. Likely intended locations: 1) same text with normalized whitespace, lines 26-26: 24: --radius-md: 16px; 25: font-fami
