...
- **CRITICAL: Do NOT use em dashes (—) in any tweet.** Use periods, commas, colons, or hyphens instead. Em dashes are an AI tell.
...
3. Generate a fresh, high-quality tweet (distinct from everything already recorded). **Scan for em dashes before posting.**
...
- Tweets remain consistent, non-repetitive, and free of em dashes over time.
...
- Em-dash filter added [2026-06-09] per user feedback that em dashes signal AI writing.
