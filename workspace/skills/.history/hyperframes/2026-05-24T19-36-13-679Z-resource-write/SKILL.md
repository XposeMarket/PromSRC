...
## Prometheus Creative Mode Note

When working inside Prometheus Creative Mode, HyperFrames is the deterministic composition language, not the whole production pipeline. Use Prometheus Creative tools for project state, generated footage, continuity, layer extraction, rough cuts, overlays, audio, captions, and final compositing:

- Generated shots and continuity: `creative_generate_image_shot`, `creative_generate_video_shot`, `creative_extract_video_frames`, `creative_pick_continuity_frame`, `creative_chain_scene`.
- Projects and takes: `creative_create_project`, `creative_create_storyboard`, `creative_register_generation`, `creative_generation_history`, `creative_select_best_take`.
- Editable overlays/composites: `creative_generate_motion_graphics_layer`, `creative_overlay_hyperframes_on_video`, `creative_composite_video_layers`.
- Audio/captions: `creative_import_audio`, `creative_download_audio`, `creative_extract_audio_from_video`, `creative_generate_voiceover`, `creative_transcribe_audio`, `creative_sync_captions_to_audio`, `creative_add_music_bed`, `creative_add_sound_effects`, `creative_mix_audio_tracks`.
