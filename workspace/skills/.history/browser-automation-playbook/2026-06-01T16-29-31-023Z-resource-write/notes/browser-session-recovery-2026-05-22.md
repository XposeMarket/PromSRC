...
2. If `target:"user_chrome"` fails because the user's normal Chrome is already open, switch to the Prometheus browser target unless Raul specifically needs user-Chrome profile state.
