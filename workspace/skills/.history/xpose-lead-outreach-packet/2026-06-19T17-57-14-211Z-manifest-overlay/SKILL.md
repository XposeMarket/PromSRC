...
description: Use this skill when packaging an already-qualified Xpose Market local-business lead into a manual outreach, demo, or sales packet using existing audit, business-intel, pitch, demo, and brand assets. Triggers on phrases like xpose outreach packet, manual outreach packet, package this lead, turn audit into sales packet, create outreach copy for lead, xpose pitch packet, demo packet for this lead, and prepare sales materials. Use it to assemble persuasive outreach assets while preserving explicit no-external-contact guardrails.
triggers:
  ...
  - demo packet for this lead
  - prepare sales materials
  - local business outreach packet
  - xpose demo packet
  - sales packet for lead
  - audit to outreach copy
categories:
  - sales
  - xpose
  - outreach
