...
## Successful sequence observed on 2026-05-08, reinforced on 2026-05-11, and hardened on 2026-05-12
...
4. For scheduled collectors, prefer a **text-first/no-screenshot** collection plan unless the job is explicitly pinned to a vision-capable model. Do not call `browser_vision_screenshot`, screenshot observation modes, desktop screenshots, image-analysis tools, or Telegram screenshot tools in the scheduled collector path when text/DOM collection is sufficient.
