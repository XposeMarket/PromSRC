...
## Successful sequence observed on 2026-05-08
...
7. Synthesize into a dated markdown report with:
   - collection health
   - rough sample sizes
   - top signals with source/account/link/snippet/why it matters/recommended action
   - deferred/noisy areas
   - blockers, if any
8. Write the dated report and copy/update `latest-daily-x-signal.md`.
9. If the run found important signal or hit a blocker, write a short continuity note.
