...
Date: 2026-05-30
Context: the user asked Prom to clear whatever was currently typed in the Claude desktop app chat box without sending anything.
...
- Do **not** use modifier-clicks unless the UI truly needs them; the user prefers normal screenshot-grounded coordinate clicks.
