...
Safer recipe when Raul asks for proof after desktop work:
...
3. Send the fresh captured screenshot using the desktop/Telegram proof tool for screenshots, rather than reusing an internal `screenshot_id`, capture id, or attachment id as a file path.
