...
Full historical test notes (TinyFish rollout observations, specific query examples) are archived in `notes/tested-tool-behavior-snapshot-2026-05-08.md` if deeper context is ever needed.
...
| Date | Version | Change |
|---|---:|---|
| 2026-07-03 | 1.1.0 | Archived the 2026-05-08 dated tool-behavior test log to `notes/tested-tool-behavior-snapshot-2026-05-08.md`; replaced with durable "Multi-Engine Search Notes" section. Consolidated duplicate batch-fetch and X-fetch guidance that had drifted into two places. |
