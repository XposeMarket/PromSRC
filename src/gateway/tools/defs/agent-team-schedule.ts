          ...
          properties: {
            ...
            patch: {
              ...
              properties: {
                ...
                model: { type: 'string' },
                reasoning_effort: { type: 'string', enum: ['', 'low', 'medium', 'high', 'xhigh', 'max', 'ultra'], description: 'Reasoning override. Independent of name/model; empty clears it.' },
            ...
            reasoning_effort: { type: 'string', enum: ['', 'low', 'medium', 'high', 'xhigh', 'max', 'ultra'], description: 'For action="update": reasoning override, independent of name/model. Empty clears it.' },
      ...
      function: {
        ...
        parameters: {
          ...
          properties: {
            ...
            reasoning_effort: { type: 'string', enum: ['', 'low', 'medium', 'high', 'xhigh', 'max', 'ultra'], description: 'Optional reasoning override, independent of name/model; pass an empty string to clear' },
      ...
      function: {
        ...
        parameters: {
          ...
          properties: {
            ...
            reasoning_effort: { type: 'string', enum: ['low', 'medium', 'high', 'xhigh', 'max', 'ultra'], description: 'Optional reasoning override for benchmark_disposable.' },
            timeout_ms: { type: 'number' },
          },
        },
      },
      ...
      function: {
        ...
        parameters: {
          ...
          properties: {
            ...
            reasoning_effort: { type: 'string', enum: ['low', 'medium', 'high', 'xhigh', 'max', 'ultra'], description: 'For create/create_many: optional reasoning effort for this new chat. If supplied, the chat gets a sticky route.' },
