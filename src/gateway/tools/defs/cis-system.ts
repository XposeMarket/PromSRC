      ...
      function: {
        ...
        parameters: {
          ...
          properties: {
            ...
            triggers: { type: 'string', description: 'Comma-separated or JSON-array trigger phrases.' },
            addTriggers: { type: 'string', description: 'Triggers to append during update_metadata.' },
            removeTriggers: { type: 'string', description: 'Triggers to remove during update_metadata.' },
            ...
            repairs: { type: 'array', items: { type: 'object' }, description: 'Repair entries for repair_metadata apply.' },
          },
        },
      },
    },
