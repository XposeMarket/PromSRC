      ...
      function: {
        ...
        parameters: {
          ...
          properties: {
            ...
            provider: { type: 'string', enum: ['auto', 'openai', 'openai_codex', 'xai'], description: 'Optional provider override. Image supports OpenAI/OpenAI Codex/xAI; video supports xAI Grok Imagine.' },
