  ...
  const tools = [
    ...
    },
    {
      ...
      function: {
        ...
        description: 'Unified Creative image/asset wrapper for importing, searching, generating, analyzing, fitting, extracting layers, icons, ASCII assets, and generation history.',
        parameters: {
          type: 'object',
          required: ['action'],
          properties: {
            action: { type: 'string', enum: ['add_asset', 'import_asset', 'analyze_asset', 'extract_layers', 'extract_layers_for_generation', 'search_assets', 'generate_asset', 'register_generation', 'generation_history', 'fit_asset', 'search_icons', 'render_ascii_asset', 'normalize_layer_specs'] },
            assetId: { type: 'string' },
