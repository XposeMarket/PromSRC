...
const TOKEN_ESTIMATES: Partial<Record<InstructionSegmentId, number>> = {
  ...
  'tools.category.media_assets': 149, 'tools.category.media_generation': 120, 'tools.category.automations': 90,
  'tools.category.automation_scheduling': 70, 'tools.category.automation_tasks': 65, 'tools.category.automation_recovery': 75, 'tools.category.automation_sessions': 70,
  'tools.category.runtime_admin': 120,
