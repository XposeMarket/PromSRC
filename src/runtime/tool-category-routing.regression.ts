...
const CASES: Case[] = [
  ...
  { id: 'external-my-github', message: 'Check my GitHub notifications.', expected: ['external_apps'] },
  ...
  { id: 'external-apple-messages', message: 'Read Apple Messages for the latest reply.', expected: ['external_apps'] },
  ...
  { id: 'external-gmail', message: 'Search my connected Gmail for the latest invoice.', expected: ['external_apps'] },
