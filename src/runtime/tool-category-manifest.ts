...
const AUTOMATIONS = names('schedule_job_detail schedule_job_history schedule_job_log_search schedule_job_outputs schedule_job_patch schedule_job_stuck_control task_control run_task_now internal_watch prometheus_request_ops');
