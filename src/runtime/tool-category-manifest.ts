...
const CORE_OVERRIDES = names('browser_send_to_telegram delivery_send delivery_send_screenshot connector_list generate_image generate_video chat_with_subagent agent_run_ops work_context_execute');
