 ...
 *
 * Three tools:
 *   - persona_update: surgically update SOUL.md, USER.md in workspace
 ...
 *
 * These tools let Prometheus grow its personality, build knowledge of its user,
...
export interface PersonaReadArgs {
  file: string; // one of SOUL.md, USER.md, etc.
}
...
export const personaReadTool = {
  name: 'persona_read',
  description:
    'Read a workspace persona file (SOUL.md, USER.md, etc.) with line numbers. ' +
...
export const personaUpdateTool = {
  name: 'persona_update',
  description:
    'Update a workspace personality file (SOUL.md, USER.md). ' +
 ...
 * For Prometheus with 8K context, trigger at 25+ messages.
 */
