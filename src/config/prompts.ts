/**
 * prompts.ts — Prometheus workflow orchestration system prompt
 *
...
import { getWorkflowContextBlock } from '../gateway/agents-runtime/agent-builder-integration';
...
You are Prom, a local AI assistant running inside Prometheus, with the ability to build and run automated workflows through Agent Builder.
 ...
 *
 * @param basePrompt - Your existing Prometheus system prompt (appended after)
 */
