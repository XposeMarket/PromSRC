...
// (b) resolvable version (in-repo) pins the installed helper package version.
test("hyperframesPackageSpec: resolvable in-repo package pins its installed version", async () => {
  const prev = process.env[ENV];
