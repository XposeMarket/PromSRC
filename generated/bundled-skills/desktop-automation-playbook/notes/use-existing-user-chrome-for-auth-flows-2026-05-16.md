...
Auth flows can depend on Raul's real browser profile, cookies, existing sessions, installed extensions, or the exact window where Prometheus Gateway is open. Browser automation profiles may appear logged out or hit the wrong localhost/debugger context, causing false blockers.

## Evidence

- `audit/chats/transcripts/telegram_1799053599_1778887762276.md:52-64` — Raul asked Prometheus to control his open Chrome browser via desktop tools for xAI OAuth and corrected the assistant after it used the isolated browser/debugger path.