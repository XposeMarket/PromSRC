# Migrated html-interactive guidance

This reference preserves detailed guidance from the former `html-interactive` entrypoint. Read it only for the matching operation.
