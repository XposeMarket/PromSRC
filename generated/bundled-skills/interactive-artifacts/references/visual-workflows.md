...
| Interactive widget, dashboard, calculator, step-through, slider, form | **`interactive-artifacts`** |
...
- **"I want to interact with / adjust / filter"** → `interactive-artifacts`
- **"Show the flow / sequence / steps"** → `mermaid-diagrams`
- **Report with charts + KPIs combined** → `interactive-artifacts` (it can embed Chart.js)
...
- Dashboard with multiple charts + KPI numbers → `interactive-artifacts`
