...
- If a Browse.sh/site-specific product extraction resource exists, use it as selector/schema intelligence, but execute with Prometheus-native tools unless Raul explicitly asks for Browse CLI.
