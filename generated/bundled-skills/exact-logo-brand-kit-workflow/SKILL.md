...
description: Reusable workflow for creating client brand-kit mockups with exact logo preservation. Prevents logo hallucination by using deterministic asset placement instead of relying on image generation alone. Includes preprocessing, compositing, and explicit fidelity QA.
emoji: "🎨"
version: 1.0.0
---
...
## Frederick Roof Repair: Failure-to-Success Case Study

### The Problem

On 2026-05-07, Raul requested a brand-kit mockup using Frederick Roof Repair's logo. The process revealed a critical failure mode:
...
5. **Client frustration:** Raul repeatedly corrected Prom, saying "that's not the fucking logo bruh" and "can you not see the fucking image?" The issue was that Prom was generating polished mockups but with the wrong logo.
...
- Frederick Roof Repair case study: `audit/chats/transcripts/ff09183e-554a-43d1-82ab-1b678a4e000e.md:25–207`
