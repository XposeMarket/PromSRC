# Migrated xlsx-reader guidance

This reference preserves detailed guidance from the former `xlsx-reader` entrypoint. Read it only for the matching operation.
...
| Error | Fix |
|---|---|
| `Cannot find module 'xlsx'` | Run `node workspace\doc-skills-setup.js` from `<prometheus-workspace>` |
