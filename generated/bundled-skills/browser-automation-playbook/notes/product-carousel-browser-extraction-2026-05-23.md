...
If Raul asks to find products on a shopping site, compare purchasable items, or show products/items in a carousel, use browser extraction when web_fetch is insufficient or when live page data/images/prices are needed.
