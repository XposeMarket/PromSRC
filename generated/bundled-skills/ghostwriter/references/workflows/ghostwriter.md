# Reusable workflow recipe: ghostwriter

Source candidate: sg_ca5f5f558854d6ad
...
## Learned Behavior
Consider adding a compact example, checklist, or template resource to ghostwriter that captures the successful sequence and any useful constraints.
