...
- Treat the request as **read-only competitor/product intelligence** unless the user explicitly asks to post, reply, like, quote, follow, bookmark, or DM.
...
- Separate validation/positioning signals from real product gaps; the user has repeatedly clarified that competitor signals do not automatically mean Prometheus lacks the core primitive.
