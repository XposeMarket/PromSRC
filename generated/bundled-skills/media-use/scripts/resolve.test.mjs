...
const CORE_COLOR_GRADING_SOURCE = join(REPO_ROOT, "packages/core/src/colorGrading.ts");
...
const CAN_TSX = existsSync(CORE_COLOR_GRADING_SOURCE) &&
...
function normalizeWithCoreSource(grading) {
  const code = `
    import { normalizeHfColorGrading } from ${JSON.stringify(pathToFileURL(CORE_COLOR_GRADING_SOURCE).href)};
