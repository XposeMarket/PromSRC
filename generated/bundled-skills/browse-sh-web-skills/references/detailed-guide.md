...
| The skill is reusable for the user/Prometheus | Create or update a Prometheus skill with the imported playbook |
...
- Prefer read-only extraction unless the user explicitly asks for interaction.
