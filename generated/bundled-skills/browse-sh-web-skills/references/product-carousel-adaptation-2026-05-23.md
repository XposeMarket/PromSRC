...
Shopping/product carousel workflows are read-only. Do not click Add to Cart, Buy Now, Subscribe, checkout, or account actions unless Raul explicitly asks and final-action approval is used.