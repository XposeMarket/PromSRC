# Migrated docx-reader guidance

This reference preserves detailed guidance from the former `docx-reader` entrypoint. Read it only for the matching operation.
...
```powershell
node workspace\_tmp_docread.js "<prometheus-workspace>\workspace\uploads\example.docx"
```
...
Example:
- `<prometheus-workspace>\workspace\uploads\my-file.docx`
