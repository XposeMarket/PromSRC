import{H as g,I as u,O as U,P as V}from"./chunk-ZOTV2UJX.js";import{d as K}from"./chunk-5RLMNBA7.js";import{a as B}from"./chunk-K22DCNID.js";import"./chunk-IXHIMEGA.js";import{h,jb as j}from"./chunk-FE2DGIO6.js";import"./chunk-YMT6MSCC.js";import{b as F,c as C,f as J,g as L}from"./chunk-KFOVD3R2.js";import"./chunk-JF4LWGNM.js";import"./chunk-CP4XDM65.js";import"./chunk-EPSJJCWL.js";var oe={openai:["gpt-6-astra","gpt-5.6-sol","gpt-5.6-terra","gpt-5.6-luna","gpt-5.5","gpt-5.4-pro","gpt-5.4","gpt-5.4-mini","gpt-5.4-nano","gpt-5-pro","gpt-5","gpt-5-mini","gpt-5-nano","gpt-5-chat-latest","gpt-4.1","gpt-4.1-mini","gpt-4o","gpt-4o-mini","o4-mini","o3","o1"],openai_codex:["gpt-6-astra","gpt-5.6-sol","gpt-5.6-terra","gpt-5.6-luna","gpt-5.5","gpt-5.4-codex","gpt-5.4-codex-mini","gpt-5.4","gpt-5.4-mini","gpt-5.3-codex","gpt-5.3-codex-spark","gpt-5.3","gpt-5.2-codex","gpt-5.2","gpt-5.1-codex-max","gpt-5.1-codex-mini","gpt-5.1-codex","gpt-5.1"],anthropic:["claude-fable-5-1","claude-fable-5","claude-opus-5","claude-opus-4-8","claude-opus-4-7","claude-opus-4-6","claude-sonnet-5","claude-sonnet-4-6","claude-sonnet-4-5-20250514","claude-haiku-4-5-20251001"],perplexity:["sonar-pro","sonar","sonar-reasoning-pro","sonar-reasoning","sonar-deep-research"],gemini:["gemini-2.5-pro","gemini-2.5-flash","gemini-2.5-flash-lite","gemini-2.0-flash","gemini-1.5-pro","gemini-1.5-flash"],xai:["grok-4.7","grok-4.6","grok-4.5","grok-composer-2.5-fast","grok-4.3","grok-4.3-latest","grok-latest","grok-4.20-0309-reasoning","grok-4.20-0309-non-reasoning","grok-4.20-multi-agent-0309","grok-4.20-multi-agent","grok-build-0.1"]},w=null;async function re(t=!1){if(w&&!t)return w;try{let e=await h("/api/extensions/catalog?kind=provider");w=Array.isArray(e?.items)?e.items:[]}catch{w=w||[]}return w}function A(t,e=""){let s=String(t||"").trim(),n=(w||[]).find(a=>a&&a.id===s)||null,o=[],d=a=>{if(Array.isArray(a))for(let i of a){let v=String(i&&i.name||i||"").trim();v&&!o.includes(v)&&o.push(v)}};d(n&&n.runtime&&n.runtime.options&&n.runtime.options.staticModels),d(oe[s]);let c=String(e||"").trim();return c&&!o.includes(c)&&o.unshift(c),o}var H=[{id:"system",title:"System",icon:"gear",desc:"Theme-independent runtime and automatic chat settling."},{id:"heartbeat",title:"Heartbeat",icon:"clock",desc:"Background heartbeat cadence and instructions."},{id:"search",title:"Search",icon:"target",desc:"Preferred web search provider."},{id:"credentials",title:"Credentials",icon:"gear",desc:"Search keys, vault status, and audit log."},{id:"security",title:"Security",icon:"check",desc:"Workspace and file access allow/block lists."},{id:"models",title:"Models",icon:"brain",desc:"LLM providers, defaults, brain, and compaction."},{id:"agents",title:"Agents",icon:"robot",desc:"Agent list and model defaults."},{id:"channels",title:"Channels",icon:"send",desc:"Telegram, Discord, and WhatsApp connections."},{id:"integrations",title:"Integrations",icon:"paperclip",desc:"Webhooks and MCP servers."}],ie=new Set(H.map(t=>t.id));function G(t,e="muted"){return`<div class="pm-settings-status ${e}">${u(t||"")}</div>`}function b(t,e,s="gear",n=""){return`<article class="pm-card pm-settings-card ${n}">
  ...
  </div>`}function _(t,e){return t.querySelector(`#${CSS.escape(e)}`)?.classList.contains("on")===!0}function l(t,e){return String(t.querySelector(`#${CSS.escape(e)}`)?.value||"").trim()}function ae(t){return String(t||"").split(",").map(e=>e.trim()).filter(Boolean)}function z(t){return String(t||"").split(`
`).map(e=>e.trim()).filter(Boolean)}function p(t,e,s="muted"){let n=t.querySelector("#pm-settings-live-status");n&&(n.className=`pm-settings-status ${s}`,n.textContent=e||"")}function I(t){t.querySelectorAll("[data-toggle-bool]").forEach(e=>{e.addEventListener("click",()=>{let s=!e.classList.contains("on");e.classList.toggle("on",s),e.setAttribute("aria-pressed",s?"true":"false")})})}function Y(t){return{openai:"OpenAI API",openai_codex:"OpenAI OAuth",anthropic:"Anthropic",xai:"xAI / Grok",ollama:"Ollama",gemini:"Gemini",perplexity:"Perplexity",elevenlabs:"ElevenLabs"}[t]||t.replace(/_/g," ").replace(/\b\w/g,s=>s.toUpperCase())}function de(t){let e=t?.providers&&typeof t.providers=="object"?t.providers:{},s=Object.keys(e);return s.includes("ollama")||s.push("ollama"),s.includes("openai")||s.push("openai"),s.includes("openai_codex")||s.push("openai_codex"),s.includes("anthropic")||s.push("anthropic"),s.includes("xai")||s.push("xai"),s}function le(t=""){return`<div class="pm-settings-section-grid">
  ...
  `;let c=e.querySelector("#pm-auto-settle-after"),a=e.querySelector("#pm-auto-settle-custom-wrap");c?.addEventListener("change",()=>{a&&(a.style.display=c.value==="custom"?"block":"none")}),e.querySelector("#pm-preview-auto-settle")?.addEventListener("click",async()=>{try{p(e,"Previewing protected-state checks...");let v=(await h("/api/settings/auto-settle/preview",{method:"POST",body:JSON.stringify({})}))?.summary||{};p(e,`${Number(v.wouldSettle||0)} eligible \xB7 ${Number(v.scanned||0)} scanned.`,"ok")}catch(i){p(e,i.message,"error")}}),e.querySelector("#pm-save-auto-settle")?.addEventListener("click",async()=>{let i=c?.value||"0",v={afterDays:i==="custom"?"custom":Number(i),activationMode:"start_now"};if(i==="custom"){if(v.customDate=l(e,"pm-auto-settle-custom-date"),!v.customDate){p(e,"Choose a custom cutoff date first.","error");return}let y=new Date(`${v.customDate}T00:00:00`);if(v.customDateOffsetMinutes=Number.isFinite(y.getTime())?y.getTimezoneOffset():new Date().getTimezoneOffset(),v.activationMode=await ue(),!v.activationMode)return}try{await h("/api/settings/session",{method:"POST",body:JSON.stringify({autoSettle:v})}),p(e,"Auto-settle settings saved.","ok"),await ee(t,e)}catch(y){p(e,y.message,"error")}})}async function he(t,e){let[s,n,o]=await Promise.all([h("/api/settings/provider"),h("/api/settings/session").catch(()=>null),j().catch(()=>null),re()]),d=s?.llm||{},c=d.provider||"ollama",a=de(d),i=d.providers?.[c]||{},v=n?.session||{};t.innerHTML=`
    ${b("Runtime",`<div class="pm-settings-kv">
      <span>Current model</span><strong>${u(o?.currentModel||i.model||"Unknown")}</strong>
      <span>Provider</span><strong>${u(Y(c))}</strong>
      <span>Status</span><strong>${o?.providerOnline?"Online":"Unknown"}</strong>
    </div>`,"brain")}
    ${b("Provider",`
      ${r("Active provider",f("pm-set-provider",a.map(y=>({value:y,label:Y(y)})),c))}
      <div id="pm-provider-fields">${Q(c,i)}</div>
    ...
    `,"clipboard")}
  `,I(e),e.querySelector("#pm-set-provider")?.addEventListener("change",()=>{let y=l(e,"pm-set-provider"),k=d.providers?.[y]||{},P=e.querySelector("#pm-provider-fields");P&&(P.innerHTML=Q(y,k)),I(e)}),e.querySelector("#pm-refresh-models")?.addEventListener("click",async()=>{p(e,"Loading models...");try{let y=q(e,d),k=y.provider,P=await h("/api/models/test",{method:"POST",body:JSON.stringify({llm:y})}),T=(P.models||[]).map(S=>typeof S=="string"?S:S.name||String(S)).filter(Boolean),E=e.querySelector(`#${CSS.escape(R(k))}`);if(E&&T.length&&E.tagName==="SELECT"){let S=E.value;E.innerHTML=x(k,T).map(W=>`<option value="${u(W.value)}">${u(W.label)}</option>`).join(""),S&&T.includes(S)&&(E.value=S)}p(e,T.length?`${T.length} model(s) found.`:P.error||"No models found.",T.length?"ok":"warn")}catch(y){p(e,y.message,"error")}}),e.querySelector("#pm-test-model")?.addEventListener("click",async()=>{p(e,"Testing provider...");try{let y=q(e,d),k=await h("/api/models/test",{method:"POST",body:JSON.stringify({llm:y})});p(e,k.success?`Connected. ${Array.isArray(k.models)?k.models.length:0} models returned.`:k.error||"Could not connect",k.success?"ok":"warn")}catch(y){p(e,y.message,"error")}}),e.querySelector("#pm-save-model")?.addEventListener("click",async()=>{p(e,"Saving model settings...");try{let y=q(e,d);await h("/api/settings/provider",{method:"POST",body:JSON.stringify({llm:y})}),p(e,"Model settings saved.","ok")}catch(y){p(e,y.message,"error")}}),e.querySelector("#pm-save-session")?.addEventListener("click",async()=>{try{await h("/api/settings/session",{method:"POST",body:JSON.stringify({rollingCompactionEnabled:_(e,"pm-session-roll"),compactionThreshold:Number(l(e,"pm-session-compact")),memoryFlushThreshold:Number(l(e,"pm-session-memory")),rollingCompactionToolTurns:Number(l(e,"pm-session-tool-turns")),rollingCompactionSummaryMaxWords:Number(l(e,"pm-session-words")),rollingCompactionModel:l(e,"pm-session-model")})}),p(e,"Compaction settings saved.","ok")}catch(y){p(e,y.message,"error")}})}function q(t,e){let s=l(t,"pm-set-provider")||e.provider||"ollama",n={...e.providers||{}};n[s]={...n[s]||{}};let o=n[s],d=l(t,R(s));d&&(o.model=d);let c=l(t,te(s));c?o.endpoint=c:delete o.endpoint;let a=l(t,se(s));a&&(o.api_key=a);let i=l(t,ne(s));if(i&&J(s,o.model,i)?o.reasoning_effort=i:delete o.reasoning_effort,s==="anthropic"){o.extended_thinking=_(t,"pm-anthropic-thinking");let y=Number(l(t,"pm-anthropic-budget"));y&&(o.thinking_budget=y)}let v=l(t,`pm-speed-${s}`);return L(s,o.model)?o.speed=v==="fast"?"fast":"standard":delete o.speed,delete o.fast_mode,{...e,provider:s,providers:n}}function R(t){return`pm-model-${t}`}function te(t){return`pm-endpoint-${t}`}function se(t){return`pm-key-${t}`}function ne(t){return`pm-effort-${t}`}function Q(t,e={}){let s=R(t),n=te(t),o=se(t),d=ne(t);if(t==="ollama")return`
      ${r("Endpoint",m(n,e.endpoint||"http://localhost:11434"))}
      ${r("Active Model",m(s,e.model||"",'placeholder="qwen3:4b"'))}
    `;if(t==="llama_cpp")return`${r("Endpoint",m(n,e.endpoint||"http://localhost:8080"))}${r("Model name",m(s,e.model||"",'placeholder="qwen2.5-7b"'))}`;if(t==="lm_studio")return`${r("Endpoint",m(n,e.endpoint||"http://localhost:1234"))}${r("Model name",m(s,e.model||"",'placeholder="qwen2.5-7b-instruct"'))}`;if(t==="openai"){let c=C(t,e.model||"gpt-5.5").map(a=>({value:a,label:a||"provider default"}));return`
      ${r("API Key",m(o,e.api_key||"",'type="password" placeholder="sk-..."'))}
      ${r("Model",f(s,x(t,A(t,e.model||"gpt-5.5")),e.model||"gpt-5.5"))}
      ${c.length>1?r("Reasoning Effort",f(d,c,e.reasoning_effort||"")):""}
    ...
    `}if(t==="openai_codex"){let c=C(t,e.model||"gpt-5.5").map(a=>({value:a,label:a||"provider default"}));return`
      ${r("Model",f(s,x(t,A(t,e.model||"gpt-5.5")),e.model||"gpt-5.5"))}
      ${r("Reasoning Effort",f(d,c,e.reasoning_effort||""))}
      ${L(t,e.model||"gpt-5.5")?r("Speed",f(`pm-speed-${t}`,[{value:"standard",label:"Standard"},{value:"fast",label:"Fast"}],e.speed||(e.fast_mode===!0?"fast":"standard"))):""}
    ...
    `}if(t==="anthropic"){let c=F(t,e.model||"claude-sonnet-5"),a=C(t,e.model||"claude-sonnet-5").map(i=>({value:i,label:i||"provider default"}));return`
  ...
  `,e.querySelector("#pm-save-search")?.addEventListener("click",async()=>{try{await h("/api/settings/search",{method:"POST",body:JSON.stringify({preferred_provider:l(e,"pm-search-provider"),search_rigor:s.search_rigor||"verified",tavily_api_key:s.tavily_api_key||"",tinyfish_api_key:s.tinyfish_api_key||"",google_api_key:s.google_api_key||"",google_cx:s.google_cx||"",brave_api_key:s.brave_api_key||""})}),p(e,"Search settings saved.","ok")}catch(n){p(e,n.message,"error")}})}async function ge(t,e){let n=(await h("/api/settings/heartbeat")).heartbeat||{};t.innerHTML=b("Heartbeat",`
    ...
    <div id="pm-settings-live-status"></div>
  `,"clock","pm-card-strong"),I(e),e.querySelector("#pm-save-heartbeat")?.addEventListener("click",async()=>{try{await h("/api/settings/heartbeat",{method:"POST",body:JSON.stringify({enabled:_(e,"pm-hb-enabled"),interval_minutes:Number(l(e,"pm-hb-interval")),model:l(e,"pm-hb-model"),review_teams_after_run:_(e,"pm-hb-review"),instructions:e.querySelector("#pm-hb-instructions")?.value||""})}),p(e,"Heartbeat settings saved.","ok")}catch(o){p(e,o.message,"error")}})}async function be(t,e){let s=await h("/api/settings/paths").catch(()=>({}));t.innerHTML=`
    ${b("File Access",`
...
`),'rows="5"'))}
  ...
  `;let c=()=>ke(e,{telegram:n,discord:o,whatsapp:d});e.querySelector("#pm-channel-select")?.addEventListener("change",c),c(),e.querySelector("#pm-channel-save")?.addEventListener("click",async()=>{let a=l(e,"pm-channel-select")||"telegram";try{await h("/api/channels/config",{method:"POST",body:JSON.stringify({channels:{[a]:N(e,a)}})}),p(e,`${a} settings saved.`,"ok")}catch(i){p(e,i.message,"error")}}),e.querySelector("#pm-channel-test")?.addEventListener("click",async()=>{let a=l(e,"pm-channel-select")||"telegram";try{let i=await h(`/api/channels/test/${a}`,{method:"POST",body:JSON.stringify(N(e,a))});p(e,i.success?`${a} connection test passed.`:i.error||`${a} test failed.`,i.success?"ok":"error")}catch(i){p(e,i.message,"error")}}),e.querySelector("#pm-channel-send")?.addEventListener("click",async()=>{let a=l(e,"pm-channel-select")||"telegram";try{let i=await h(`/api/channels/send-test/${a}`,{method:"POST",body:JSON.stringify(N(e,a))});p(e,i.success?`Test message sent via ${a}.`:i.error||"Send test failed.",i.success?"ok":"error")}catch(i){p(e,i.message,"error")}})}function ke(t,e){let s=l(t,"pm-channel-select")||"telegram",n=e[s]||{},o=t.querySelector("#pm-channel-status-card"),d=t.querySelector("#pm-channel-form"),c=t.querySelector("#pm-channel-guide");o&&(o.innerHTML=`<div class="pm-settings-channel">
