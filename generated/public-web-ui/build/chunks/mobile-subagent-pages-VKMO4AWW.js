import{a as xt,b as _t,c as Mt,d as Tt}from"./chunk-JIQYDNXI.js";import{c as wt,d as kt,e as At,f as xe,g as _e}from"./chunk-PPD7UNFQ.js";import{C as ee,D as gt,E as yt,F as ht,G as ft,M as St,N as $t,O as te,a as rt,b as nt,d as Z,e as Se,f as it,g as ot,h as de,i as ct,j as lt,l as X,m as dt,o as pt,r as $e,s as ut,t as mt,u as pe,v as we,w as bt,x as ke,y as vt,z as Ae}from"./chunk-E22B7CFJ.js";import{b as Y}from"./chunk-J5HXEABW.js";import{a as C}from"./chunk-35CAQ6TV.js";import{F as h,G as p,M as fe,N as le}from"./chunk-FTHBNOGB.js";import{$ as ye,_ as Ke,aa as We,ba as Ze,c as Qe,ca as Je,da as he,ea as ie,fa as Ye,ga as Xe,ha as oe,ia as et,ja as tt,ka as at,la as st,m as Ue,pb as J,r as Ge,ub as ce}from"./chunk-NA5E5ZCP.js";import"./chunk-5RLMNBA7.js";import{a as Ne,b as Be,c as Oe}from"./chunk-Y4UKNDXR.js";import"./chunk-JVBLTJT2.js";import"./chunk-FSM6R34L.js";import"./chunk-YMT6MSCC.js";import"./chunk-ESWDUEET.js";import{e as ge}from"./chunk-CUCDWB4G.js";import"./chunk-NFAP2WUZ.js";import{e as Fe,f as je,g as Ve}from"./chunk-XREJVKMI.js";import"./chunk-FIRMLDAQ.js";import"./chunk-JF4LWGNM.js";import{a as R}from"./chunk-GBLBNUG2.js";import"./chunk-IPNQ4FF4.js";import"./chunk-36KIJFV6.js";import"./chunk-EPSJJCWL.js";var ue={running:{label:"running",cls:"running"},idle:{label:"idle",cls:"gray"},scheduled:{label:"scheduled",cls:"orange"},team:{label:"team",cls:"active"},failed:{label:"failed",cls:"orange"}};function Ht(r){let e=ue[r.status]||ue.idle;return`
  ...
  `,le(r,{});let m=r.querySelector("#pm-subagents-body"),o=r.querySelector("#pm-subagents-count");async function c({force:b=!1}={}){let v=[];try{v=await Ke({force:b})}catch(A){m.innerHTML=`<div class="pm-empty"><div class="pm-empty-icon">${h.robot}</div><h2>Couldn\u2019t load subagents</h2><p>${p(A.message||"Network error")}</p></div>`,o.textContent="0 agents";return}if(o.textContent=`${v.length} agent${v.length===1?"":"s"}`,!v.length){m.innerHTML=`<div class="pm-empty"><div class="pm-empty-icon">${h.robot}</div><h2>No subagents yet</h2><p>Create agents from the desktop Settings \u2192 Agents page.</p></div>`;return}let i=v[0],S=`
  ...
  `,le(r,{onBack:()=>u?.("#mobile/subagents")});let o=r.querySelector("#pm-detail-body"),c=null;try{c=await ye(e)}catch(d){o.innerHTML=`<div class="pm-empty"><div class="pm-empty-icon">${h.robot}</div><h2>Couldn\u2019t load subagent</h2><p>${p(d.message||"Network error")}</p></div>`;return}if(!c){o.innerHTML=`<div class="pm-empty"><div class="pm-empty-icon">${h.robot}</div><h2>Subagent not found</h2><p>${p(e)} isn\u2019t available right now.</p></div>`;return}let g=ue[c.status]||ue.idle,b=["Overview","Chat","Memory","Runs","Heartbeat"],v=`pm-sa-model-${c.id}`,i=`pm-sa-voice-${c.id}`,S=String(c.effectiveModel||c.model||"").trim();o.innerHTML=`
  ...
  `,(async()=>{try{let d=await tt(e),l=o.querySelector("#pm-subagent-ctxrefs-body");if(!l)return;if(!d.length){l.innerHTML='<em style="color:var(--pm-muted);">No context references attached.</em>';return}l.innerHTML=d.slice(0,10).map(f=>`
        <div class="pm-ctxref">
  ...
  `,document.body.appendChild(u);let m=()=>u.remove();u.addEventListener("click",o=>{(o.target===u||o.target.getAttribute("data-close"))&&m()}),u.querySelector("#pm-dispatch-submit").addEventListener("click",async()=>{let o=String(u.querySelector("#pm-dispatch-task").value||"").trim();if(!o){C("Describe the task first","error");return}let c=u.querySelector("#pm-dispatch-submit");c.disabled=!0,c.innerHTML="\u2026sending";try{let g=await at(r,o);if(g?.success){let b=String(g.result?.result||g.result?.summary||"").slice(0,140);C(b?`Done \xB7 ${b}`:"Task complete","success"),m()}else C(g?.error||"Dispatch failed","error"),c.disabled=!1,c.innerHTML=`${h.send} Dispatch`}catch(g){C(g.message||"Dispatch failed","error"),c.disabled=!1,c.innerHTML=`${h.send} Dispatch`}}),setTimeout(()=>u.querySelector("#pm-dispatch-task")?.focus(),50)}async function It(r,e){let[u,m]=await Promise.all([We(e),Ze(e)]),o=[{key:"agent",title:"AGENT.md",content:u,exists:!!u,empty:"No AGENT.md is set for this agent yet."},{key:"memory",title:"MEMORY.md",content:m.content,exists:m.exists,empty:"No personal memory file exists for this agent yet."}],c="",g=()=>{r.innerHTML=`<section class="pm-subagent-memory" aria-label="Subagent memory files">
...
`,m.index+m[0].length);return{raw:e.slice(u.index,c===-1?e.length:c),path:String(u[1]||"").trim(),sha256:String(m[1]||"").trim(),size:String(o?.[1]||"").trim()}}function Lt(r,{compact:e=!1}={}){let u=String(r||"").trim();if(!u)return"";let m=Bt(u),o=m?u.replace(m.raw,"").trim():u,c=e&&o.length>420?`${o.slice(0,417).trimEnd()}...`:o,g=c?`<div class="pm-sa-run-summary markdown-body">${lt(c)}</div>`:"";return m?`${g}
  ...
  `;let c=r.querySelector("#pm-hb-tick");c&&c.addEventListener("click",async()=>{let g=c.innerHTML;c.disabled=!0,c.innerHTML="\u2026ticking";try{let b=await he(e);if(b?.success===!1)throw new Error(b?.error||"Failed");C("Heartbeat ticked","success"),await Rt(r,e)}catch(b){C(b.message||"Tick failed","error"),c.disabled=!1,c.innerHTML=g}})}async function Ft(r,e,u){let m=ge(e.id);r.innerHTML=`
