<<<<<<<< HEAD:generated/public-web-ui/build/chunks/mobile-subagent-pages-GEZF4NJJ.js
import{a as At,b as _t,c as Mt,d as Tt}from"./chunk-3OOKRQ4A.js";import{c as wt,d as kt,e as xt,f as Ae,g as _e}from"./chunk-2XTT2X2A.js";import{B as ee,C as gt,D as yt,E as ht,F as ft,L as St,M as $t,N as te,a as rt,b as nt,d as W,e as Se,f as it,g as ot,h as de,i as ct,j as lt,l as X,m as dt,n as pt,q as $e,r as ut,s as mt,t as pe,u as we,v as bt,w as ke,x as vt,y as xe}from"./chunk-UPTWZPPU.js";import{b as Y}from"./chunk-J5HXEABW.js";import{a as C}from"./chunk-35CAQ6TV.js";import{F as h,G as p,M as fe,N as le}from"./chunk-O5C7MZFW.js";import{e as J,j as ce}from"./chunk-OFQVUS33.js";import"./chunk-GEC7XXFC.js";import"./chunk-3VFN2RV3.js";import{a as Ye,b as Xe,c as et}from"./chunk-ACPZYBFH.js";import"./chunk-MGDZYTA3.js";import{e as he}from"./chunk-CUCDWB4G.js";import"./chunk-YGZSSPM3.js";import{c as Ne,ca as Fe,da as ge,ea as je,fa as Ve,ga as Qe,ha as ye,ia as ie,ja as Ue,ka as Ge,la as oe,m as Be,ma as Ke,na as We,oa as Ze,pa as Je,s as Oe}from"./chunk-K25O5QNI.js";import"./chunk-YMT6MSCC.js";import{e as tt,f as at,g as st}from"./chunk-XREJVKMI.js";import"./chunk-4WCZDNBS.js";import"./chunk-3EPMIDRU.js";import"./chunk-JF4LWGNM.js";import"./chunk-IPNQ4FF4.js";import{a as R}from"./chunk-GBLBNUG2.js";import"./chunk-36KIJFV6.js";import"./chunk-EPSJJCWL.js";var ue={running:{label:"running",cls:"running"},idle:{label:"idle",cls:"gray"},scheduled:{label:"scheduled",cls:"orange"},team:{label:"team",cls:"active"},failed:{label:"failed",cls:"orange"}};function Ht(r){let e=ue[r.status]||ue.idle;return`
========
import{a as At,b as _t,c as Mt,d as Tt}from"./chunk-CWBUOLFU.js";import{c as wt,d as kt,e as xt,f as Ae,g as _e}from"./chunk-CEXX5A7U.js";import{B as ee,C as gt,D as yt,E as ht,F as ft,L as St,M as $t,N as te,a as rt,b as nt,d as W,e as Se,f as it,g as ot,h as de,i as ct,j as lt,l as X,m as dt,n as pt,q as $e,r as ut,s as mt,t as pe,u as we,v as bt,w as ke,x as vt,y as xe}from"./chunk-VNQQFW27.js";import{b as Y}from"./chunk-J5HXEABW.js";import{a as C}from"./chunk-35CAQ6TV.js";import{F as h,G as p,M as fe,N as le}from"./chunk-DEYEDI7X.js";import{e as J,j as ce}from"./chunk-NQO4BGNT.js";import"./chunk-GEC7XXFC.js";import"./chunk-3VFN2RV3.js";import{a as Ye,b as Xe,c as et}from"./chunk-ACPZYBFH.js";import"./chunk-MGDZYTA3.js";import{e as he}from"./chunk-CUCDWB4G.js";import"./chunk-YGZSSPM3.js";import{c as Ne,ca as Fe,da as ge,ea as je,fa as Ve,ga as Qe,ha as ye,ia as ie,ja as Ue,ka as Ge,la as oe,m as Be,ma as Ke,na as We,oa as Ze,pa as Je,s as Oe}from"./chunk-4MLV3F4Z.js";import"./chunk-YMT6MSCC.js";import{e as tt,f as at,g as st}from"./chunk-XREJVKMI.js";import"./chunk-4WCZDNBS.js";import"./chunk-3EPMIDRU.js";import"./chunk-JF4LWGNM.js";import"./chunk-IPNQ4FF4.js";import{a as R}from"./chunk-GBLBNUG2.js";import"./chunk-36KIJFV6.js";import"./chunk-EPSJJCWL.js";var ue={running:{label:"running",cls:"running"},idle:{label:"idle",cls:"gray"},scheduled:{label:"scheduled",cls:"orange"},team:{label:"team",cls:"active"},failed:{label:"failed",cls:"orange"}};function Ht(r){let e=ue[r.status]||ue.idle;return`
>>>>>>>> eb2f8735 (chore(web): refresh final telemetry production artifacts):generated/public-web-ui/build/chunks/mobile-subagent-pages-GGTSKWFL.js
  ...
  `,document.body.appendChild(u);let m=()=>u.remove();u.addEventListener("click",o=>{(o.target===u||o.target.getAttribute("data-close"))&&m()}),u.querySelector("#pm-dispatch-submit").addEventListener("click",async()=>{let o=String(u.querySelector("#pm-dispatch-task").value||"").trim();if(!o){C("Describe the task first","error");return}let c=u.querySelector("#pm-dispatch-submit");c.disabled=!0,c.innerHTML="\u2026sending";try{let y=await Ze(r,o);if(y?.success){let b=String(y.result?.result||y.result?.summary||"").slice(0,140);C(b?`Done \xB7 ${b}`:"Task complete","success"),m()}else C(y?.error||"Dispatch failed","error"),c.disabled=!1,c.innerHTML=`${h.send} Dispatch`}catch(y){C(y.message||"Dispatch failed","error"),c.disabled=!1,c.innerHTML=`${h.send} Dispatch`}}),setTimeout(()=>u.querySelector("#pm-dispatch-task")?.focus(),50)}async function It(r,e){let[u,m]=await Promise.all([je(e),Ve(e)]),o=[{key:"agent",title:"AGENT.md",content:u,exists:!!u,empty:"No AGENT.md is set for this agent yet."},{key:"memory",title:"MEMORY.md",content:m.content,exists:m.exists,empty:"No personal memory file exists for this agent yet."}],c="",y=()=>{r.innerHTML=`<section class="pm-subagent-memory" aria-label="Subagent memory files">
    ...
    </section>`,r.querySelectorAll("[data-memory-file]").forEach(b=>b.addEventListener("click",()=>{let g=b.getAttribute("data-memory-file")||"";c=c===g?"":g,y()})),r.querySelectorAll("[data-memory-copy]").forEach(b=>b.addEventListener("click",()=>{let g=o.find(n=>n.key===b.getAttribute("data-memory-copy"));xe(g?.content||"",b)}))};y()}function Nt(r){return String(r||"Task").replace(/^\s*\[\s*(?:subagent|agent)\s*\]\s*/i,"").trim()||"Task"}function Bt(r){let e=String(r||""),u=e.match(/\*\*Ready artifact\*\*\s*[-:]\s*`([^`\n]+)`/i),m=e.match(/\bSHA-?256:\s*`?([a-f0-9]{32,})`?/i);if(!u||!m)return null;let o=e.match(/\bSize:\s*\*{0,2}([\d,.]+\s*(?:bytes?|kb|mb|gb))\*{0,2}/i),c=e.indexOf(`
