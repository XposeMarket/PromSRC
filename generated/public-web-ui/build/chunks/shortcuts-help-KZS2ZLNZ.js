import{a as c}from"./chunk-CP4XDM65.js";var r=[{title:"General",items:[{combo:"Ctrl + N",desc:"New chat"},{combo:"Ctrl + K",desc:"Open command palette (search chats, pages, actions)"},{combo:"Ctrl + /",desc:"Show this shortcuts list"},{combo:"Esc",desc:"Close dialogs and overlays"}]},{title:"Command Palette",items:[{combo:"\u2191 / \u2193",desc:"Move selection"},{combo:"Enter",desc:"Run selected item"},{combo:"Esc",desc:"Close palette"}]}],e=null,t=null;function a(){if(e)return;e=document.createElement("div"),e.id="shortcuts-help-overlay",e.className="cmdk-overlay",e.style.display="none";let o=r.map(l=>`
