...
The checked-in [tool-observation history snapshot](../benchmarks/tool-observations/baseline-2026-09-02.json) contains the most recent bounded 50,000 persisted observations from the local legacy runtime. It covers 412 historical tool names, including 88 currently registered native tools and 303 historical-only names. Across that window, summed tool duration was 114,001,347 ms, p50/p95 latency was 31/6,902 ms, args/result/context tokens were 7,865,161 / 134,018,865 / 141,884,026, result bytes were 428,754,753, and estimated context cost was $177.835608. This is a prioritization signal, not a controlled before/after experiment.
