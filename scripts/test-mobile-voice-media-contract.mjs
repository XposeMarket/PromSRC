...
assert.match(pages, /realtime-agent-live-camera-resumed-after-xai-vision-response/);
...
assert.match(generatedPages, /realtime-agent-live-camera-resumed-after-xai-vision-response/);
