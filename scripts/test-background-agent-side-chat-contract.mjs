...
assert.match(work, /sameStream && normalizedLastSeq > previousLastSeq/);
assert.match(work, /mergeBackgroundAgentEvents\(previousEvents, normalized\.events\)/);
assert.match(work, /mergeBackgroundAgentTraceEntries\(previous\.liveTraceEntries, normalized\.liveTraceEntries\)/);
