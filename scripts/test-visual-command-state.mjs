...
assert.match(utils, /export function preserveVisualIframes/);
assert.match(utils, /export function setInnerHTMLPreservingVisuals/);
...
assert.match(desktop, /setInnerHTMLPreservingVisuals\(container/);
assert.match(mobile, /setInnerHTMLPreservingVisuals\(threadEl/);
