...
const helperStart = mobile.indexOf('function _compactMobileThreadCacheFileChanges(');
const helperEnd = mobile.indexOf('\nfunction _compactMobileThreadCacheValue', helperStart);
...
const compactFileChanges = new Function(
  `${mobile.slice(helperStart, helperEnd)}; return _compactMobileThreadCacheFileChanges;`,
)();
